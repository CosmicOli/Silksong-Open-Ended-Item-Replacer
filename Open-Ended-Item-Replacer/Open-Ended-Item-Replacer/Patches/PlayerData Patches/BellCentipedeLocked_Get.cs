...
namespace Open_Ended_Item_Replacer.Patches.PlayerData_Patches
{
    [HarmonyPatch(typeof(PlayerData), "BellCentipedeLocked", MethodType.Getter)]
    internal class BellCentipedeLocked_Get
    {
        ...
        {
            if (__instance.bellCentipedeAppeared)
            {
